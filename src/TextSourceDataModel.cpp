...
TextSourceDataModel::TextSourceDataModel()
        :_lineEdit(new QLineEdit("My def text"))
{
    connect(_lineEdit, &QLineEdit::textEdited,
            this, &TextSourceDataModel::onTextEdited);
}

//TextSourceDataModel::TextSourceDataModel(const TextSourceDataModel&) = default;

TextSourceDataModel::~TextSourceDataModel() = default;
